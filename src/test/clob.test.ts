import { CLOBEngine } from '../clob/OrderBook';
...
function runTests(): void {
  ...
  const engine = new CLOBEngine('test-market');
  ...
  const engine2 = new CLOBEngine('test-market-2');
  ...
  const engine3 = new CLOBEngine('test-market-3');
  ...
  const engine4 = new CLOBEngine('test-market-4');
  ...
  // Test 7: Cancel order
  const engine5 = new CLOBEngine('test-market-5');
